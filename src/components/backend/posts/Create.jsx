...
import { ChevronLeft, Upload, AlertCircle, Save, Eye, FileText, User, Tag, ImageIcon } from 'lucide-react';
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-slate-600 mt-1">Create and publish new blog articles</p>
              </div>
              <a
                href="/admin/posts"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8 border-t border-slate-200">
                ...
                >
                  ...
                  {isDisable ? 'Publishing...' : 'Publish Article'}
                </button>
